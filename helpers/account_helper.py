...
from clients.http.dm_api_account.models.request_models.change_email import ChangeEmail
from clients.http.dm_api_account.models.request_models.change_password import ChangePassword
from clients.http.dm_api_account.models.request_models.login_credentials import LoginCredentials
from clients.http.dm_api_account.models.request_models.registration import Registration
from clients.http.dm_api_account.models.request_models.reset_password import ResetPassword
...
class AccountHelper:
    ...
    @allure.step("Аутентификация пользователя auth_client")
    ...
    @allure.step("Аутентификация пользователя user_login")
    ...
    @allure.step("Получить активационный токен по логину")
    ...
    @retrier(retry_count=5, retry_delay=1)
    @allure.step("Получить активационный токен по mailbox")
    ...
    @retrier(retry_count=5, retry_delay=1)
    @allure.step("Получить токен сброса пароля по логину")
